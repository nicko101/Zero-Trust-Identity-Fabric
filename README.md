...
#### 1. The Virtualization Layer (Proxmox and GNS3)
...
#### 2. Authentication and Authorization (802.1X and DUR)
...
#### 3. The Dual-Tunnel Hybrid Transit Hub
...
#### 4. Automated Identity Lifecycle (SCEP and App Proxy)
